     ...
     ?>
      ...
      <div class="container-fluid bg-breadcrumb">
                <div class="container text-center py-5" style="max-width: 900px;">
                    <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">M. Pharm Pharmacology</h4>
                    <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                        <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">Pages</a></li>
                        <li class="breadcrumb-item active text-primary">M. Pharm Pharmacology</li>
                    </ol>    
                </div>
            </div>
            <!-- Header End -->
                ...
                <div class="row g-5">
                    <div class="col-xl-6 wow fadeInLeft" data-wow-delay="0.2s">
                        <div class="about-img rounded ">
                            ...
                            <div class="about-exp"><span>M. Pharm Pharmacology - 15</span></div>
                        </div>
                    </div>
                    <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.2s">
                        <div class="about-item">
                            ...
                            <p align="jusitfy">B.Pharmacy with an aggregate score of atleast 55% (50% for candidates of reserved category) or valid GPAT score
                               </p>
                        </div>
                    </div>
                </div>
